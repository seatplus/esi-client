 ...
 */
readonly class GetDogmaEffectsEffectIdResponse
{
    ...
    public static function from(object $data): self
    {
        return new self(
            ...
            modifiers: isset($data->modifiers) ? array_map(fn(object $i) => GetDogmaEffectsEffectIdResponseModifiersItem::from($i), (array) $data->modifiers) : null,
            name: $data->name ?? null,
